...
df_train = pd.read_csv('data/raw/metadata_train.csv')
...
def prep_data(start, end):
    ...
    praq_train = pq.read_pandas('data/raw/train.parquet', columns=[str(i) for i in range(start, end)]).to_pandas()
    X = []
    y = []
...
for start, end in start_end:
    subset_test = pq.read_pandas('data/raw/test.parquet', columns=[str(i) for i in range(start, end)]).to_pandas()

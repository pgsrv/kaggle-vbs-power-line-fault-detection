...
if __name__ == '__main__':
    ...
    save_dir = Path(
        "/mnt/share/vbs-power-line-fault-detection/models/hierarchical_gru_context/summary/window_{}_step_{}".format(
            200, 200))
    ...
    df = model.predict(feature, batch_size=128, measurement_ids=test_dataset.measurement_ids)

...
from runner.model.plot_model_runner import ResNet18BaggingKfoldModel
...
if __name__ == '__main__':
    ...
    baging_model = ResNet18BaggingKfoldModel(model_path_root=model_root,
                                             dropout_rate=0.5, threshold=0.5)

    df = baging_model.predict(plot_root, batch_size=800)

...
from runner.model.base_runner import GruTrainRunner
...
if __name__ == '__main__':
    ...
    save_dir = Path(
        "/mnt/share/vbs-power-line-fault-detection/models/gru/fft/fft_5000_pca_200_scaled")

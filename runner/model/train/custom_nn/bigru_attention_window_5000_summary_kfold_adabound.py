...
if __name__ == '__main__':
    ...
    save_dir = Path(
        "/mnt/share/vbs-power-line-fault-detection/models/bigru_attention/window_5000_summary_adabound")
    ...
    runner = BiGruAttensionTrainRunner(params,
                                       train_batch_size=512, valid_batch_size=512,
                                       n_epochs=200, lr=1e-3, weight_decay=1e-5, patience=50,
                                       n_fold=10)

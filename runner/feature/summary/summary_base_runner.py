...
def run(window_size, step_size):
    root = Path(
        "/mnt/share/vbs-power-line-fault-detection/features/summary/window_{}_step_{}".format(window_size,
                                                                                              step_size))
    ...
    feature = SummaryWindowFeature(window_size=window_size, step_size=step_size)

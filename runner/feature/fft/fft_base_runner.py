...
from feature.base import FftFeature
from utils.data import dataset


def run(fft_length, fft_stride):
    feature = FftFeature(fft_length=fft_length, fft_stride=fft_stride)
    root = Path(

...
def run():
    root = Path("/mnt/share/vbs-power-line-fault-detection/features/percentile_summary/window_160_step_160")
    ...
    feature = PercentileSummaryWindowFeature(window_size=160, step_size=160)
